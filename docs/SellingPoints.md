...
　このゲームでは音楽の再生が重要な要素です。  
再生する音楽はmp3やwaveなどの音声ファイルではなく、SMF(Standard Midi File)を使っています。  
SMFは「楽器」「音階」「再生時間」の情報を持っており、音源は入っていません。  
SMFを使うことでゲーム内の各ミニキャラがそれぞれの楽器別で演奏することを実現、  
再生速度も簡単に変えることができました。  
