#include "MiniCharaTubar.h"
#include "../MiniChara.h"


void MiniCharaTubar::Init(MiniChara& _self)
{
	ResourceSystem& rsrcSystem{ _self.System().Get<ResourceSystem>() };

	_self.hImage_ = rsrcSystem.LoadTexture("Image/MiniChara/Tubar.png");
...
void MiniCharaTubar::Update(MiniChara& _self)
{
